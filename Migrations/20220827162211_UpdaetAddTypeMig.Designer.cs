...
namespace HorseService.Migrations
{
    ...
    [Migration("20220827162211_UpdaetAddTypeMig")]
    partial class UpdaetAddTypeMig
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AdditionalTypeAppointments", b =>
                {
                    b.Property<int>("AdditionalTypesAdditionalTypeId")
                        .HasColumnType("int");

                    b.Property<int>("AppointmentsId")
                        .HasColumnType("int");

                    b.HasKey("AdditionalTypesAdditionalTypeId", "AppointmentsId");

                    b.HasIndex("AppointmentsId");

                    b.ToTable("AdditionalTypeAppointments");
                });
            ...
            modelBuilder.Entity("AdditionalTypeAppointments", b =>
                {
                    b.HasOne("HorseService.Models.AdditionalType", null)
                        .WithMany()
                        .HasForeignKey("AdditionalTypesAdditionalTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HorseService.Models.Appointments", null)
                        .WithMany()
