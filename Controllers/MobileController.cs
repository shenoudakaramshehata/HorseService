...
namespace HorseService.Controllers
{
    ...
    //    public MobileController(HorseServiceContext context, SignInManager<ApplicationUser> signInManager, UserManager<ApplicationUser> userManager,
    ...
    //    }
    //    [HttpPost]
    //    public ActionResult<object> Addorder([FromQuery] int CustomerId , [FromQuery] int PaymentMethodId)
    //    {
    //        try
    //        {
